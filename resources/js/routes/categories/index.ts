...
/**
* @see \App\Http\Controllers\SuperAdmin\CategoryController::index
 * @see app/Http/Controllers/SuperAdmin/CategoryController.php:0
...
/**
* @see \App\Http\Controllers\SuperAdmin\CategoryController::create
 * @see app/Http/Controllers/SuperAdmin/CategoryController.php:0
...
/**
* @see \App\Http\Controllers\SuperAdmin\CategoryController::store
 * @see app/Http/Controllers/SuperAdmin/CategoryController.php:12
 * @route '/super-admin/categories'
 */
...
/**
* @see \App\Http\Controllers\SuperAdmin\CategoryController::show
 * @see app/Http/Controllers/SuperAdmin/CategoryController.php:0
 * @route '/super-admin/categories/{category}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: '/super-admin/categories/{category}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    show.form = showForm
/**
* @see \App\Http\Controllers\SuperAdmin\CategoryController::edit
 * @see app/Http/Controllers/SuperAdmin/CategoryController.php:0
 * @route '/super-admin/categories/{category}/edit'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/super-admin/categories/{category}/edit',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\SuperAdmin\CategoryController::update
 * @see app/Http/Controllers/SuperAdmin/CategoryController.php:30
 * @route '/super-admin/categories/{category}'
 */
...
/**
* @see \App\Http\Controllers\SuperAdmin\CategoryController::destroy
 * @see app/Http/Controllers/SuperAdmin/CategoryController.php:44
 * @route '/super-admin/categories/{category}'
 */
