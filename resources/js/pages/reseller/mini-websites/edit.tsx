...
export default function ResellerMiniWebsiteEdit({ website }: { website: any }) {
                ...
                <div className="bg-white border-b px-6 py-4 flex items-center justify-between shrink-0">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <a href={`/sites/${website.slug}`} target="_blank" rel="noreferrer" className="text-xs text-indigo-600 hover:underline flex items-center gap-1">
