            ...
            <div className="relative min-h-screen bg-[#fdfbf7] text-[#4a4238] font-sans selection:bg-[#3d5644] selection:text-white transition-colors overflow-hidden">
                    ...
                    <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            <div className="text-[#3d5644]">
                                <AppLogoIcon className="size-10 fill-current text-[#3d5644]" />
                            </div>
                            <span className="font-serif text-2xl md:text-3xl font-bold tracking-wide text-[#3e3832]">
                                Invitify
                            </span>
                        </div>
                ...
                <section className="relative z-10 max-w-6xl mx-auto px-6 py-20 lg:py-28">
                    <div className="grid lg:grid-cols-12 gap-12 items-center">
                        {/* Hero Left Content */}
                        <div className="lg:col-span-7 flex flex-col gap-5 text-left items-start relative">
                            ...
                            <p className="max-w-md text-[#706557] font-serif text-lg sm:text-xl leading-relaxed mt-2 border-b border-[#ebd9c1] pb-6">
                ...
                <section id="digital-business-cards" className="relative z-10 max-w-6xl mx-auto px-6 py-16">
                    ...
                    <div className="grid gap-6 grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 relative w-full max-w-5xl mx-auto">
                        {showcasedDigitalCards.slice(0, 5).map((t, idx) => (
                            <div
                                key={t.id}
                                className={`group flex flex-col items-center hover:-translate-y-1 transition-all duration-300 relative ${idx === 2 ? 'z-20 transform scale-110 -translate-y-4' : 'z-10'}`}
                            >
                                {/* Mobile Phone Mockup */}
                ...
                <footer className="bg-[#fdfbf7] border-t border-[#ebd9c1] py-12 text-center text-xs text-[#706557] mt-20 transition-colors">
