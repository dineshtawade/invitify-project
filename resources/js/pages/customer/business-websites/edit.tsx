...
export default function BusinessWebsiteEdit({ website }: { website: any }) {
    ...
    const handleSave = () => {
        put(`/customer/business-websites/${website.id}`);
    };
            ...
            <div className="flex flex-col h-[calc(100vh-4rem)]">
                ...
                <div className="border-b px-6 py-4 flex items-center justify-between shrink-0">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <Button onClick={handleSave} disabled={processing} className="bg-blue-600 hover:bg-blue-700 text-white shadow-md">
