...
if($_SERVER['HTTP_HOST']=="localhost"){$connect=mysqli_connect("localhost","digca76_abc","digca76_abc","digca76_abc") or die ('Database not available...');}else {$connect=mysqli_connect("localhost","u620508530_theinvitify","theinvitifyA123456","u620508530_theinvitify") or die ('Connection issue #567845 Error');}
