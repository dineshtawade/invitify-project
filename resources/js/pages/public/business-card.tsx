        ...
        <div className="min-h-screen bg-[#111] flex justify-center pb-12">
            ...
            <div className="w-full max-w-[480px] bg-[#1e1e1e] min-h-screen flex flex-col">
                        ...
                        <div className="share_wtsp">
                            ...
                            >
                                <input
                                    ...
                                    className="bg-transparent text-gray-800 px-2 py-1 flex-1 text-sm border-0 focus:ring-0 outline-none"
                                />
                ...
                <div className="card2" id="about_us">
                    <h3>About Us</h3>
                    {personal.est_date && <p className="text-xs text-gray-600 italic mt-1">Est. Since {personal.est_date}</p>}
                    <p className="mt-2 text-sm leading-relaxed text-gray-600">{personal.about_us || 'No company details shared yet.'}</p>
                </div>
