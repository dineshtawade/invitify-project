...
/**
* @see \App\Http\Controllers\SuperAdmin\UserController::index
 * @see app/Http/Controllers/SuperAdmin/UserController.php:16
...
/**
* @see \App\Http\Controllers\SuperAdmin\UserController::create
 * @see app/Http/Controllers/SuperAdmin/UserController.php:0
...
/**
* @see \App\Http\Controllers\SuperAdmin\UserController::store
 * @see app/Http/Controllers/SuperAdmin/UserController.php:57
 * @route '/super-admin/users'
 */
...
/**
* @see \App\Http\Controllers\SuperAdmin\UserController::show
 * @see app/Http/Controllers/SuperAdmin/UserController.php:0
 ...
 */
    ...
    show.form = showForm
/**
* @see \App\Http\Controllers\SuperAdmin\UserController::edit
 * @see app/Http/Controllers/SuperAdmin/UserController.php:0
 * @route '/super-admin/users/{user}/edit'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/super-admin/users/{user}/edit',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\SuperAdmin\UserController::update
 * @see app/Http/Controllers/SuperAdmin/UserController.php:0
 * @route '/super-admin/users/{user}'
 */
...
/**
* @see \App\Http\Controllers\SuperAdmin\UserController::destroy
 * @see app/Http/Controllers/SuperAdmin/UserController.php:0
 * @route '/super-admin/users/{user}'
 */
...
const UserController = { index, create, store, show, edit, update, destroy, approve }
