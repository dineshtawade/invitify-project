...
/**
* @see \App\Http\Controllers\SuperAdmin\ReferralController::index
...
const ReferralController = { index, storeCode, assignAllocation, updatePermissions, toggleCode, destroyCode }
