...
/**
* @see \App\Http\Controllers\SuperAdmin\TransactionController::index
...
/**
* @see \App\Http\Controllers\SuperAdmin\TransactionController::create
 * @see app/Http/Controllers/SuperAdmin/TransactionController.php:0
 * @route '/super-admin/transactions/create'
 */
...
create.definition = {
    methods: ["get","head"],
    url: '/super-admin/transactions/create',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\SuperAdmin\TransactionController::store
 * @see app/Http/Controllers/SuperAdmin/TransactionController.php:0
 * @route '/super-admin/transactions'
 */
...
/**
* @see \App\Http\Controllers\SuperAdmin\TransactionController::show
 * @see app/Http/Controllers/SuperAdmin/TransactionController.php:0
 * @route '/super-admin/transactions/{transaction}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: '/super-admin/transactions/{transaction}',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    show.form = showForm
/**
* @see \App\Http\Controllers\SuperAdmin\TransactionController::edit
 * @see app/Http/Controllers/SuperAdmin/TransactionController.php:0
 * @route '/super-admin/transactions/{transaction}/edit'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/super-admin/transactions/{transaction}/edit',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\SuperAdmin\TransactionController::update
 * @see app/Http/Controllers/SuperAdmin/TransactionController.php:0
 * @route '/super-admin/transactions/{transaction}'
 */
...
/**
* @see \App\Http\Controllers\SuperAdmin\TransactionController::destroy
 * @see app/Http/Controllers/SuperAdmin/TransactionController.php:0
 * @route '/super-admin/transactions/{transaction}'
 */
